...
<header class="<?php if($page == 'index' || $page == 'products'){echo 'indexNav';}?> main-header-media1200">
    <nav class="nav-media1200 main-nav-media1200">
        ...
        <h1 class="business-name-media1200"><a href="index.php" class="animate__animated animate__backInDown">Patisserie</a></h1>
        ...
        <ul class="animate__animated animate__backInDown">
            ...
            <!-- <li><span class="user-logout"><a href="logout.php"><button type="button" title="Logout" class="btn btn-danger"><span class="glyphicon glyphicon-log-in"></span></button></a></span></li> -->
        </ul>
    </nav>
</header>
